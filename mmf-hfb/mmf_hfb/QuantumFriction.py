...
class LQF1d(BCS):
    ...
    def __init__(self, N, L, beta_0=1.0, beta_V=1.0, beta_K=1.0):
        """
        Arguments
        ---------
        beta_0 : float
    ...
    def get_Kc(self, phis):
        pass

    def apply_expK(self, psis, factor=1):
        # we want to apply fft on the each wavefunction
        # may need to apply on u and v seperately
        # psi_ks = self.fft(psis, axis=1)
        pass
